...
window.location="duzenle.php?uye="+id;
}
</script>
<div id="container">
		<div id="header">
	   ...
	   ?>
		...
		?>
            ...
            <p><form id="sess" name="sess" method="post" action="duzenle.php">
            <label>Eposta adresi:<input type="text" name="eposta" id="eposta" /></label><input name="submit1" id="submit1" type="submit" value="Oturum aç">
            </form></p>
